...
from WaitHelper import WaitHelper
...
class EpicGamesConnect:
    ...
    def free_games_cost(driver):
        driver.switch_to.window(driver.window_handles[0])  # Son eklenen pencerenin tanımlayıcısını al
        WaitHelper.random_sleep(5, 7)
        ...
        # Free Now Cost elementine tıklamak için Selenium kullanımı
        if free_now_cost:
